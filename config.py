...
GEMINI_MODEL_PRO = os.environ.get("HV_GEMINI_MODEL_PRO", "gemini-2.5-pro")
OPENAI_API_KEY = os.environ.get("HV_OPENAI_KEY", "")
OPENAI_MODEL = os.environ.get("HV_OPENAI_MODEL", "gpt-4o-mini")
ANTHROPIC_API_KEY = os.environ.get("HV_ANTHROPIC_KEY", "")
ANTHROPIC_MODEL = os.environ.get("HV_ANTHROPIC_MODEL", "claude-sonnet-4-5-20250929")
...
# Agency gets Gemini Pro (smarter scoring, better emails, deeper analysis)
# Growth/Free get Gemini Flash (fast, cost-effective)
TIER_MODELS = {
    "agency": GEMINI_MODEL_PRO if AI_PROVIDER == "gemini" else LM_STUDIO_MODEL,
    "growth": GEMINI_MODEL if AI_PROVIDER == "gemini" else LM_STUDIO_MODEL,
    "free":   GEMINI_MODEL if AI_PROVIDER == "gemini" else LM_STUDIO_MODEL,
}
