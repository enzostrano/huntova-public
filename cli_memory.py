...
Pattern adapted from OpenClaw's `openclaw memory`; independent Python
implementation specialised for Huntova's lead+hunt+feedback tables.
...
def register(sub) -> None:
    ...
    m = sub.add_parser("memory",
        ...
        description="Inspect leads, hunts, feedback, emails. "
                    "Pattern adapted from OpenClaw `openclaw memory`.")
