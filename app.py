...
def run_agent():
    ...
    if not _has_searxng:
        # Cycle through public fallbacks if the user hasn't overridden.
        _PUBLIC_FALLBACKS = ["https://searx.be", "https://search.brave4u.com",
                              "https://paulgo.io", "https://search.disroot.org"]
        _orig = SEARXNG_URL
    ...
    if _has_searxng:
        ...
        emit_status("HV-E1001 Search engine offline — install SearXNG or set SEARXNG_URL", "idle")
        return
