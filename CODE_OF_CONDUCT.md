...
the Huntova project a harassment-free experience for everyone, regardless of
...
requests, discussions, and any other channels associated with the project —
...
reported privately to the project maintainers via the GitHub Security
Advisory channel at
https://github.com/enzostrano/huntova-public/security/advisories/new
or by emailing the maintainer listed in `pyproject.toml`. All complaints
