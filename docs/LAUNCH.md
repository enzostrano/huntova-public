...
huntova hunt "marketing agencies hiring video editors" --max-leads 1
                             # must save at least 1 lead to db.sqlite
```
...
huntova hunt --countries USA,UK --max-leads 50 \
  --queries "B2B SaaS growth agency 2-15 staff|technical recruiting agency devops staffing"
```
...
Step 3 (35s): $ huntova hunt "boutique creative agencies in Berlin hiring motion designers" --max-leads 6
...
Step 5 (5s): $ huntova share --leads 42-44
...
> (fit, buyability, timing, reachability, decision-making authority)
> with a Playwright deep-qualify pass on high-fit leads. A typical hunt
> returns 5-10 *qualified* prospects from 50-80 search queries, each
...
- **5 bundled plugins**: csv-sink, dedup-by-domain, slack-ping, recipe-adapter,
...
> I used the open-source CLI I just emailed you about. I ran
> `huntova hunt --queries "B2B SaaS marketing agency UK"`. It found your
> agency, extracted your name from the About page, and guessed your email
> format. You can do the exact same thing to your clients.
